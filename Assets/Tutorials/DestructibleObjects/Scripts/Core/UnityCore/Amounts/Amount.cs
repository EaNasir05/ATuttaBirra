...
public class Amount
{
    ...
    public Amount(float initialValue, float minValue,float maxValue,Action onAdd, Action onSubstract, Action onModify)
    {
        Value = initialValue;
        MinValue = minValue;
        MaxValue = maxValue;
        OnAddToTheAmount = onAdd;
        OnSubstractToTheAmount = onSubstract;
        OnAmountModified = onModify;
    }
