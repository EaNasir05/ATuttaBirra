...
public class SimpleDestructibleObject : MonoBehaviour, ICollision, IVector3
{
    ...
    public void DestroyObject(){
        ...
        foreach (GameObject piece in _piecesOfTheDestroyed)
        {
            ...
            Vector3 force = _rigidbody.linearVelocity / _piecesOfTheDestroyed.Length;
            if(_forceReceiver != null && _forceReceiver.ForceReceived.magnitude > 0)
                force = _forceReceiver.ForceReceived / _piecesOfTheDestroyed.Length;
